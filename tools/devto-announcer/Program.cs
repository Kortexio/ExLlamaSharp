...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        try
        {
            ...
            var title = $"ExLlamaSharp {tag}: what shipped";
...
public static class ArticleFormatter
{
    public static string Format(string tagName, string releaseBody, string repoUrl)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("Local LLM server for Windows with NVIDIA GPUs — OpenAI-compatible `/v1`, Blazor admin, and EXL3 inference.");
        sb.AppendLine();
        ...
        sb.AppendLine();
        sb.AppendLine("Repo: https://github.com/Kortexio/ExLlamaSharp");
        return sb.ToString();
    }
}
...
public static class DevToClient
{
        ...
        CancellationToken ct = default)
    {
        ...
        request.Headers.TryAddWithoutValidation("User-Agent", "ExLlamaSharp-devto-announcer/1.0 (+https://github.com/Kortexio/ExLlamaSharp)");
